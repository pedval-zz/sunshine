...
/**
 * Created by pedrovalencia on 21/09/2014.
 */
public class WeatherProvider  extends ContentProvider{
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(auth,WeatherContract.PATH_WEATHER,WEATHER);
        matcher.addURI(auth,WeatherContract.PATH_WEATHER +"/*",WEATHER_WITH_LOCATION);
        matcher.addURI(auth,WeatherContract.PATH_WEATHER + "/*/*",WEATHER_WITH_LOCATION_AND_DATE);

        matcher.addURI(auth, WeatherContract.PATH_LOCATION, LOCATION);
        matcher.addURI(auth,WeatherContract.PATH_LOCATION + "/#",LOCATION_ID);
