package com.pedrovalencia.sunshine.app.sync;
...
import com.pedrovalencia.sunshine.app.MainActivity;
import com.pedrovalencia.sunshine.app.R;
import com.pedrovalencia.sunshine.app.Utility;
        ...
        if ( displayNotifications ) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    int iconId = Utility.getImageList(desc);
